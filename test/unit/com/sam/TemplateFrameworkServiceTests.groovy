...
@TestFor(TemplateFrameworkService)
@Mock([TemplateFramework,Segment])
class TemplateFrameworkServiceTests {
                        ...
                        <tr>
                            <td>
                                <table width="599" border="0" align="center" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td>
                                            <a segment="推荐路线连接1" href="http://www.jinjiang.com/travel/group/853671.html?cmpid=edm_12m5_hangzhou" target="_blank">
                                            ...
                                            <a segment="推荐路线连接2" href="http://www.jinjiang.com/travel/group/857506.html?cmpid=edm_12m5_taiwan" target="_blank">
    ...
    void testCrateBaseFramework() {
        service.createBaseFramework(originContent,'testOriginCnotent')
        def templateFramework = TemplateFramework.findByTemplateName('testOriginCnotent')
        Assert.assertEquals(templateFramework.getTemplateName(),'testOriginCnotent')
    }


    void testCompile() {
        def templateFramework = new TemplateFramework(templateContent:originContent,templateName:'testOriginCnotent',templateCode:'10001')
        templateFramework.save()
        service.compileFramework('10001')
        Assert.assertEquals(templateFramework.segments.size(),1)
    }
