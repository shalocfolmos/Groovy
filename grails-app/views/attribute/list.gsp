			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="key" title="${message(code: 'attribute.key.label', default: 'Key')}" />
				...
				<g:each in="${attributeInstanceList}" status="i" var="attributeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${attributeInstance.id}">${fieldValue(bean: attributeInstance, field: "key")}</g:link></td>
