	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="create" action="create"><g:message code="person.add.label" args="[entityName]" /></g:link></li>
			</ul>
		</div>
			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="division" title="${message(code: 'person.division.label', default: 'Division')}" />
				...
				<g:each in="${personInstanceList}" status="i" var="personInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: personInstance, field: "division")}</td>
