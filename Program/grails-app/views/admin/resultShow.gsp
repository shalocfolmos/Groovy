...
<html>
	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				<li><a class="home" href="${createLink(action: "start",controller: "admin"}"><g:message code="result.button.back"/></a></li>
		...
		<div id="show-result" class="content scaffold-show" role="main">
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${resultInstance?.id}"><g:message code="result.button.edit.label" default="Edit" /></g:link>
