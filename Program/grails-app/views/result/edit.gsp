...
<html>
	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
                <li><a class="home" href="${createLink(uri: '/')}"><g:message code="result.button.back"/></a></li>
				%{--<li><g:link class="list" action="list"><g:message code="default.list.label" args="[entityName]" /></g:link></li>--}%
				%{--<li><g:link class="create" action="create"><g:message code="default.new.label" args="[entityName]" /></g:link></li>--}%
			</ul>
		</div>
		<div id="edit-result" class="content scaffold-edit" role="main">
			<h1><g:message code="result.edit.label" args="[entityName]" /></h1>
			...
			<g:form method="post" >
				...
				<fieldset class="buttons">
					<g:actionSubmit class="save" action="update" value="${message(code: 'result.button.update.label', default: 'Update')}" />
